    ...
    <div class="addmarketcontainer" style="margin: 30px 0 40px;">
        <div class="addmarket">
            <div class="svg-wrapperr">
                ...
                <a href="/typeMarche/create" class="textt">Add Type</a>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td class="linksBtn">
                        ...
                        <form id="deleteType" action="{{route('typeMarche.destroy',['id' => $marche->id])}}" method="post">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-danger" onclick="confirmDelete(event, {{ $marche->id }})">
